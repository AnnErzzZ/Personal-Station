...
type Uniform<T = number | number[]> = { value: T };
...
const SideRays = ({
  ...
  // Reduced motion keeps the ray gradient but stops it from animating.
  const animatedSpeed = reducedMotion ? 0 : speed;
...
void main() {
  ...
  gl_FragColor = color;
      ...
      const updateSize = () => {
        ...
        (uniforms.iResolution as Uniform<number[]>).value = [
          w * renderer.dpr,
          h * renderer.dpr,
        ];
      };
